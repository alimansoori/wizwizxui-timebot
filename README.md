...
```
bash <(curl -s https://raw.githubusercontent.com/alimansoori/wizwizxui-timebot/dev/wizwiz.sh)
```
...
```
bash <(curl -s https://raw.githubusercontent.com/alimansoori/wizwizxui-timebot/dev/update.sh)
```
