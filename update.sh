...
do
	case $opt in
		...
		"Update panel")
			...
			MESSAGE="🕹 FilterBeshcan panel has been successfully updated!"
		...
		"Backup")
			...
			wget https://raw.githubusercontent.com/alimansoori/wizwizxui-timebot/dev/dbbackupwizwiz.sh | chmod +x dbbackupwizwiz.sh
			./dbbackupwizwiz.sh
