	...
	case $opt in
		...
		"Update panel")
			...
			echo "Folder created successfully!"
			 ...
			 cd /var/www/html/
			 wget -O wizwizpanel.zip https://github.com/alimansoori/wizwizxui-timebot/releases/download/10.3.1/wizwizpanel.zip
		...
		"Backup")
			...
			wget https://raw.githubusercontent.com/alimansoori/wizwizxui-timebot/main/dbbackupwizwiz.sh | chmod +x dbbackupwizwiz.sh
			./dbbackupwizwiz.sh
