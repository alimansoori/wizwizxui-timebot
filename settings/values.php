...
$mainValues = [
    ...
    'customer_custome_plan_name' => 'اسم سرویس رو وارد کن ( حروف انگیلیسی و عدد باهم وارد کنید )',
...
✅ بعد از اینکه پرداختت تایید شد مبلغ مورد نظر به کیف پولت اضافه میشه!",
    ...
    'please_send_only_image_resid' => "لطفا فقط عکس از رسید پرداختی خودت ارسال کن",
...
",
    ...
    'out_of_plan_capacity' => 'ظرفیت این پلن پر شده است',
...
🔮 نام سرویس: REMARK
💮 سفارش: FILENAME",
    'renew_order_sent' => "✅| دوست عزیز ، درخواستت با موفقیت ثبت شد، بعد از بررسی و تمدید ادمین، سرویس رو برات میفرستم ممنون از صبوریت 
...
",
    ...
    'you_dont_have_config' => 'عزیزم هیچ سفارشی نداری 🙁 باید یه سرویس خریداری کنی',
...
⁮⁮ ⁮⁮ ⁮⁮ ⁮⁮
",
    'config_details_message2' => "وضعیت سرویس: STATE
...
",
    ...
    'please_wait_message_queue' => "⏳ | لطفا در صف انتظار بمانید",
    ...
    'start_message' => '🔥 سلام رفیق خوش اومدی به فیلتربشکن 🔥 
...
💰مقدار تخفیف: AMOUNT تومان
⁮⁮ ⁮⁮",
    "send_config_uuid" => "❗️| لینک سرویس یا token رو برام بفرس اطلاعات کامل رو تحویلت بدم 🤭",
...
از این بخش میتوانید خرید تکی و خرید انبوه داشته باشید و همچنین سرویس های خریداری شده را مدیریت کنید",
    'selling_is_off' => "فعلا فروش نداریم",
    'no_server_available' => "😔 | عزیز دلم هیچ سرور فعالی نداریم لطفا بعدا مجدد تست کن",
    'no_service_available' => "😔 | عزیز دلم هیچ سرویس فعالی نداریم لطفا بعدا مجدد تست کن",
    'buy_sub_select_location' => '  1️⃣ مرحله یک:

لوکیشن مدنظرت رو برا خرید انتخاب کن: 😊',
    'buy_service_select_category' => '🎯 حالا سرویس مورد نظرت رو از لیست زیر انتخاب کن تا جزییاتش رو ببینی 👇',
...
سمت راست درآمد و سمت چپ تعداد خرید نماینده می باشد',
    ...
    "sent_config_to_user" => '✅ سرویس و براش ارسال کردم
ریمارک: REMARK
حجم سرویس: VOLUME گیگ
مدت زمان سرویس: DAYS روز',
    "renewed_config_to_user" => '✅ سرویس و براش تمدید کردم
ریمارک: REMARK
حجم سرویس: VOLUME گیگ
مدت زمان سرویس: DAYS روز',
...
<b>به دلیل عدم مطابقت مبلغ تراکنش رد شد</b>",
    ...
    'config_doesnt_exist' => "سرویس یافت نشد"
];
...
$buttonValues = [
    ...
    'update_config_connection' => "⌛️ بروزرسانی سرویس",
