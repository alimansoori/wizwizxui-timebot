...
██ ███ ██ ██  ███    ██ ███ ██ ██  ███         ██ ██  ██    ██ ██ 
 ███ ███  ██ ███████  ███ ███  ██ ███████     ██   ██  ██████  ██ 
\033[0m"
echo -e "    \e[31mTelegram Channel: \e[34m@FilterBeshcan_Support\033[0m | \e[31mTelegram Group: \e[34m@wizwizdev\033[0m\n"
...
git clone https://github.com/alimansoori/wizwizxui-timebot.git /var/www/html/wizwizxui-timebot
...
(crontab -l ; echo "* * * * * curl https://${DOMAIN_NAME}/wizwizxui-timebot/settings/updateLinks.php >/dev/null 2>&1") | sort - | uniq - | crontab -
(crontab -l ; echo "* * * * * curl https://${DOMAIN_NAME}/wizwizxui-timebot/settings/queueOrders.php >/dev/null 2>&1") | sort - | uniq - | crontab -
...
wait
    ...
    if [[ $(mysql -u root -p$ROOT_PASSWORD -e "SHOW DATABASES LIKE 'wizwiz'") ]]; then
        ...
        MESSAGE="✅ The wizwiz bot has been successfully installed! @FilterBeshcan_Support"
